<?php
	header("Content-Security-Policy: script-src 'unsafe-eval' https://cdnjs.cloudflare.com/ ; object-src 'none' ; report-uri /reportURL;");
?>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body>
		...
		<div>
			...
			<h4>
				...
				<br>
				script-src 'unsafe-eval' https://cdnjs.cloudflare.com/ ; object-src 'none' ; report-uri /reportURL;
			</h4>
			<br>
			<?php
				$payload = $_GET["input"] ?? '';
